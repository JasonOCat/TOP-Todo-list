...
import Task, { isValidTaskTitle, getFormattedDueDate, updateTaskFromAllProjects } from '../task';
        ...
        <div class="task-button-container">
            ...
            <div class="task-description-and-project">
                <span class="task-date">
                    ...
                    ${task.dueDate
    ? (DateUtils.isDateToday(task.dueDate) ? '<p style="color: green;">Today</p>'
...
const initCancelAndSaveTaskButtons = (divUpdateTaskForm, taskButton, task) => {
  ...
  const updateTask = () => {
    ...
    if (
      ...
      varTask.title = inputUpdateTitle.value;
      varTask.description = inputUpdateDescription.value;
      varTask.dueDate = inputUpdateDate.value;
