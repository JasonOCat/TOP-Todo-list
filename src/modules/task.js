...
const Task = (title, description = null, dueDate = null) => {
  ...
  return {
    ...
    set description(argDescription) {
    ...
    set completed(completed) {
      if (completed === !true && completed === !false) {
        throw new Error('Please provide a valid boolean to know if the task is completed.');
      }
...
function updateTaskFromAllProjects(updatedTask) {
  ...
  realProject.tasks
    ...
    .forEach((task) => {
      const varTask = task;
      varTask.title = updatedTask.title;
      varTask.description = updatedTask.description;
      varTask.dueDate = updatedTask.dueDate;
    });
