...
var ProjectList = function () {
  var _projects = [];
  _projects.push((0,_Project__WEBPACK_IMPORTED_MODULE_0__["default"])("Inbox", true));
  _projects.push((0,_Project__WEBPACK_IMPORTED_MODULE_0__["default"])("Today", true));
  _projects.push((0,_Project__WEBPACK_IMPORTED_MODULE_0__["default"])("Upcoming", true));
...
var Task = function Task(title) {
  ...
  var isPresentOrFutureDate = function isPresentOrFutureDate(date) {
    var dateNow = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(), "dd/MM/yyyy"), "dd/MM/yyyy", new Date());
  ...
  return {
    ...
    get formattedDate() {
      if (_dueDate !== null) {
        return (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(_dueDate, 'dd/MM/yyyy');
      }
    }
  };
};
...
var MainUI = function () {
  var initHomePage = function initHomePage() {
    ...
    _ProjectViewUI__WEBPACK_IMPORTED_MODULE_3__["default"].displayProjectTasksAndTheirButtons();
  };
...
const ProjectViewUI = (() => {
    ...
    const initCancelAndSaveTaskButtons = (divUpdateTaskForm, taskButton, task) => {
        ...
        inputUpdateTitle.addEventListener('keyup', (e) => {
            if ((0,_Task__WEBPACK_IMPORTED_MODULE_0__.isValidTaskTitle)(e.target.value)) {
                saveUpdateButton.removeAttribute('disabled');
            } else {
...
_modules_ProjectList__WEBPACK_IMPORTED_MODULE_5__["default"].projects.forEach(function (project) {
...
/******/ })()
;
//# sourceMappingURL=main.52513bdf5b7f0f11986a.js.map